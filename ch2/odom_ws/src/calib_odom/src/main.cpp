...
Eigen::Vector3d  cal_delta_distence(Eigen::Vector3d odom_pose)
{
    ...
    now_pos = odom_pose;
    //TODO:
    // We assume, B as the coordinate system of last time stamp, A as the coordinate system of time stamp now
    Eigen::Matrix3d TOB;
    ...
    d_pos = Eigen::Vector3d(TBA(0, 2), TBA(1, 2), std::atan2(TBA(1, 0), TBA(0, 0)));
    //end of TODO:
    return d_pos;
}
